...
router.delete('/clinics/:id', clinicRules.deactivate, clinicsController.deactivate);

router.get('/clinics/:clinicId/users', userRules.list, usersController.getAll);
router.get('/clinics/:clinicId/users/:id', userRules.getById, usersController.getById);
...
router.delete('/clinics/:clinicId/users/:id', userRules.deactivate, usersController.deactivate);

router.get('/clinics/:clinicId/staff', staffRules.list, staffController.getAll);
router.get('/clinics/:clinicId/staff/:id', staffRules.getById, staffController.getById);
...
router.delete('/clinics/:clinicId/staff/:id', staffRules.deactivate, staffController.deactivate);

router.get('/clinics/:clinicId/services', serviceRules.list, servicesController.getAll);
router.get('/clinics/:clinicId/services/:id', serviceRules.getById, servicesController.getById);
...
router.delete('/clinics/:clinicId/services/:id', serviceRules.deactivate, servicesController.deactivate);

router.get('/clinics/:clinicId/appointments', appointmentRules.list, appointmentsController.getAllByClinic);
router.get('/clinics/:clinicId/appointments/:id', appointmentRules.getById, appointmentsController.getById);
